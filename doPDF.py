...
def bin_edit(caption):
    ...
    eta_low = remove_ch(str(r.findall(eta_low_pattern, caption))).lstrip("eta_")
    eta_high = remove_ch(str(r.findall(eta_high_pattern, caption))).lstrip("eta_" + eta_low)
    pt_low = remove_ch(str(r.findall(pt_low_pattern, caption))).lstrip("pt_")
    pt_high = remove_ch(str(r.findall(pt_high_pattern, caption))).lstrip("pt_" + pt_low)
...
def subfigure(figure, caption, plt_type):
    ...
    resolution_bins = [
        "eta_0_1.5_pt_20_50", "eta_1.5_2.8_pt_20_50", "eta_1.5_3.0_pt_20_50", "eta_1.5_3_pt_20_50", "eta_3.0_4.0_pt_20_50", "eta_4.0_5.0_pt_20_50", "eta_0_1.5_pt_50_100", "eta_1.5_2.8_pt_50_100", "eta_1.5_3.0_pt_50_100", "eta_1.5_3_pt_50_100", "eta_3.0_4.0_pt_50_100", "eta_3_4_pt_50_100", "eta_4.0_5.0_pt_50_100", "eta_0_1.5_pt_100_200", "eta_1.5_2.8_pt_100_200", "eta_1.5_3.0_pt_100_200", "eta_1.5_3_pt_100_200", "eta_3.0_4.0_pt_100_200", "eta_4.0_5.0_pt_100_200", "eta_0_1.5_pt_200_500", "eta_1.5_2.8_pt_200_500", "eta_1.5_3.0_pt_200_500", "eta_1.5_3_pt_200_500", "eta_3.0_4.0_pt_200_500", "eta_4.0_5.0_pt_200_500", "eta_0_1.5_pt_500_Inf", "eta_1.5_3.0_pt_500_Inf"
        ]
...
def main():
    ...
    os.system('pdflatex all_plots.tex -halt-on-error')
